...
- [x] Commit and push
  - **Closeout note (2026-04-04):** D1.1.A-G are complete in `D1.1_POSTGRES_MIGRATION_SUBCHECKLIST.md`, including PostgreSQL-only runtime cutover, `req/POSTGRES_MIGRATION_PLAN.md`, `backend/db/schema/001_baseline.sql`, `docs/POSTGRES_SETUP.md`, and the parent-checklist sync/closeout commits.
...
- [x] Save artifact: design doc updates
  - **Artifact:** `req/D3.2_FUTURE_INGESTION_FORMATS_DESIGN.md`
